...
class PointHeadBoxMerge(PointHeadTemplate):
    """
    ...
    def assign_targets(self, input_dict):
        ...
        """
        source_length = input_dict['point_coords'].shape[0] // 2
        point_coords = input_dict['point_coords'][:source_length]
    ...
    def forward(self, batch_dict):
        ...
        source_length = point_cls_preds.shape[0] // 2
        ret_dict = {'point_cls_preds': point_cls_preds[:source_length],
                    'point_box_preds': point_box_preds[:source_length]}

        batch_dict['point_box_preds_encoded'] = point_box_preds
            
        if self.training and batch_dict['batch_type'] == 'merge':
            targets_dict = self.assign_targets(batch_dict) # modify assign targets to assign label for source data only
